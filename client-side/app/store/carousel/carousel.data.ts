...
export const carousel: ICarousel[]= [
    ...
    },
    {
        ...
        name: 'HomePod',
        title: 'Глубокий звук',
        className: 'text-white absolute left-[47%] top-[5%]',
        classTitle: 'text-white absolute left-[45%] top-[13%]',
    },
    {
        ...
        name: 'iPhone 14 Pro',
        title: 'За пределами',
        className: 'text-white absolute left-[45%] top-[5%]',
        classTitle: 'text-white absolute left-[45%] top-[13%]',
    },
    {
        ...
        className: 'text-white absolute left-[43%] top-[5%]',
        classTitle: 'text-white absolute left-[41%] top-[13%]',
    },
    {
        ...
        className: 'text-white absolute left-[47%] top-[5%]',
        classTitle: 'text-white absolute left-[40%] top-[13%]',
    }
]